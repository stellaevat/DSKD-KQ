...
# task
TASK="dual_space_kd_with_cma_plus_kq_matching"
# hp
BATCH_SIZE=4
LR=0.0005
GRAD_ACC=2
...
# runtime
PRECISION="bf16"
CRITERION="dual_space_kd_with_cma_plus_kq_matching"
KD_OBJ=${1}  # [forward_kl, reverse_kl, js_divergence, skewed_forward_kl, skewed_reverse_kl, adaptive_kl]
CONFIG="${KQ_ADVER_TYPE}-${KD_OBJ}-${PRECISION}"
